...
namespace PublicTools.Constants
{
    public static class DatabaseConstants
    {
        ...
        {
            public const string YazdiUserId = "7b43aed3-cbdc-4fa2-9516-9e99d3e5dbbn";
            public const string YazdiFirstName = "Ameneh";
            public const string YazdiLastName = "YazdiKhosroshahi";
            public const string YazdiCellPhone = "09921808441";
            public const string YazdiPassword = "!QAZ1qaz";
        }
    }
}
